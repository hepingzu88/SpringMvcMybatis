...
<html>
	...
	<body>
		<div class="content-box">
			 <br>
			 <button class="layui-btn" id="addScene">创建实体</button>
		...
		<script type="text/javascript">
			...
			function edit(id){
		       window.location.href = "${basePath}/thesaurus/custom/custom-answer-index?id="+id;
		    }
		    ...
		    function _returnData(pageNum) {
		        var url = "${basePath}/thesaurus/entity/entity-find";
		        jump(url,pageNum);
		    }
		</script>
	</body>
