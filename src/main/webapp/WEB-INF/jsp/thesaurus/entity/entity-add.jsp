		...
		<!-- <div class="layui-tab layui-tab-card" style="height: 805px;"> -->
			...
			<form class="layui-form layui-form-pane" ><!-- action="" style="margin-left: 40px;" -->
		        ...
		        <div class="layui-form-item">  <!-- style="width: 50%;" -->
				    ...
				    <div class="layui-input-block">
				      <input name="entity" id="entity" lay-verify="required" placeholder="实体名" autocomplete="off" class="layui-input" type="text">
				    </div>
			    </div>
			    <div class="layui-form-item">  <!-- style="width: 50%;" -->
				    <label class="layui-form-label">实体英文名</label>
				    <div class="layui-input-block">
				      <input name="entityEnglish" id="entityEnglish" lay-verify="required" placeholder="实体英文名" autocomplete="off" class="layui-input" type="text">
				    </div>
			    </div>
		        <br><br>
		        <div class="layui-form-item">
	   ...
	   <script type="text/javascript">
	   	layui.use(['form'], function(){
	        ...
	        form.on('submit(from)', function(data){
	             $.post("${basePath}/thesaurus/entity/entity-add",data.field,function (res) {
	                if(res.isSuccess){
