			...
			<form class="layui-form layui-form-pane">
		        <div class="layui-form-item" >
		            ...
		            <div class="layui-input-block">
		                <input name="scene" id="scene" lay-verify="scene" placeholder="自定义场景" autocomplete="off" class="layui-input" type="text">
		            </div>
		        </div>
		        <div class="layui-form-item" >
		            <label class="layui-form-label">场景英文名</label>
		            <div class="layui-input-block">
		                <input name="sceneEnglish" id="sceneEnglish" lay-verify="required" placeholder="自定义场景" autocomplete="off" class="layui-input" type="text">
		            </div>
		        </div>
		        <br><br>
		        <div class="layui-form-item">
	   ...
	   <script type="text/javascript">
	   	layui.use(['form'], function(){
	        ...
	        form.on('submit(from)', function(data){
	             $.post("${basePath}/thesaurus/custom/custom-scene-add",data.field,function (res) {
	            	 if(res.isSuccess){
