        ...
        <c:forEach items="${page.list}" var="bean">
            <tr>
                ...
                <td>
                    ...
                    <button class="layui-btn layui-btn-small layui-btn-danger" type="button" onclick='remove(${bean.id},"${bean.affectiveName}")'>
                        <i class="layui-icon">&#xe640;</i>
                    </button>
                </td>
            </tr>
...
<c:if test="${page.list==null}">
  <span style="margin-left: 35%">你还没有情感状态，请点击创建</span>
</c:if>
