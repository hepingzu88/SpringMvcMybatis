...
<html>
	...
	<body>
		<div class="content-box">
			 <br>
			 <button class="layui-btn" id="addScene">创建情感状态</button>
		...
		<script type="text/javascript">
			layui.use(['table','jquery','element','form','layer'], function(){
			 ...
			 $("#refresh").on('click',function(){
			  ...
			  $("#addScene").on('click',function(){
				  var url ="${basePath}/thesaurus/affective/affective-add";
		            layer.open({
		                type: 2,
		                area: ['450px', '280px'],
		                offset: ['120px', '450px'],
			...
			//delte删除大分类
			 function remove(id,name){
			 	var url ="${basePath}/thesaurus/affective/affective-delete";
		        layer.confirm('确认删除', {
		            ...
		            $.post(url,{"id":id,"name":name},function (data) {
		                if(data.isSuccess){
		                    ...
		                    jump("${basePath}/thesaurus/affective/affective-index",pageNum);
		                }else{
		                	layer.msg(data.message);
		                }
		            })
		    ...
		    function _returnData(pageNum) {
		        var url = "${basePath}/thesaurus/affective/affective-index";
		        jump(url,pageNum);
		    }
		</script>
	</body>
