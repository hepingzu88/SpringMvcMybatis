		...
		<br><br>
			<form class="layui-form layui-form-pane">
	         	<div class="layui-form-item">
				    <label class="layui-form-label">情感类型</label>
				    <div class="layui-input-block">
				      <input name="affectiveName" id="affectiveName" lay-verify="required" placeholder="情感类型" autocomplete="off" class="layui-input" type="text">
				    </div>
			  	</div>
		        <br><br>
				<div class="layui-form-item">
	   ...
	   <script type="text/javascript">
	   	layui.use(['form'], function(){
	        ...
	        form.on('submit(from)', function(data){
	             $.post("${basePath}/thesaurus/affective/affective-add",data.field,function (res) {
	            	 if(res.isSuccess){
