...
<html>
	...
	<body>
		<div class="content-box">
			 <br>
			 <button class="layui-btn" id="addScene">创建行为</button>
		...
		<script type="text/javascript">
			...
			//delte删除大分类
			 function remove(id,action){
			 	var url ="${basePath}/thesaurus/action/action-delete";
		        layer.confirm('确认删除', {
		            ...
		            $.post(url,{"id":id,"action":action},function (data) {
		                if(data.isSuccess){
		                    ...
		                    jump("${basePath}/thesaurus/action/action-find",pageNum);
		                }else{
		                	  layer.msg(data.message);
		                }
		            })
		    ...
		    function _returnData(pageNum) {
		        var url = "${basePath}/thesaurus/action/action-find";
		        jump(url,pageNum);
		    }
		</script>
	</body>
