			...
			<form class="layui-form layui-form-pane"><!--  action="" style="margin-left: 40px;" -->
	         	<div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input name="action" id="action" lay-verify="required" placeholder="动作类型" autocomplete="off" class="layui-input" type="text">
				    </div>
			  	</div>
	   ...
	   <script type="text/javascript">
	   	layui.use(['form'], function(){
	        ...
	        form.on('submit(from)', function(data){
	             $.post("${basePath}/thesaurus/action/action-add",data.field,function (res) {
	            	 if(res.isSuccess){
