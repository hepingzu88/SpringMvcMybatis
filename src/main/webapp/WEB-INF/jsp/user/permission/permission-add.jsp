		        ...
		        <div class="layui-form-item">
		            <label class="layui-form-label">权限名</label>
		              <div class="layui-input-block" style="width: 70%;">
		                <input name="permissionName" lay-verify="required" placeholder="请输入权限名称" autocomplete="off" class="layui-input" type="text">
		            </div>
		        </div>
		        <div class="layui-form-item">
		            <label class="layui-form-label">权限标签</label>
		              <div class="layui-input-block" style="width: 70%;">
		                <input name="permission" lay-verify="required" placeholder="请输入权限标签" autocomplete="off" class="layui-input" type="text">
		            </div>
		        </div>
		        <br><br>
		        <div class="layui-form-item">
		...
		<script>
		    layui.use(['form','layer'], function(){
		        ...
		        form.on('submit(from)', function(data){
		            $.post("${basePath}/admin/permission/add",data.field,function (res) {
		                if(res.isSucceed){
