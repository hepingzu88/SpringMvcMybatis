		    ...
		    <form class="layui-form" action="">
		        <div class="layui-form-item">
		            ...
		            <div class="layui-input-inline">
		                <input name="permissionName" lay-verify="permissionName" autocomplete="off" class="layui-input" type="text">
		...
		<script type="text/javascript">
		   layui.use(['layer','form','jquery'], function(){
				...
				$(".add-button").on('click',function(){
					var url = "${basePath}/admin/permission/add";
					layer.open({
			            title: "新增权限",
						type: 2,
			            area: ['600px', '350px'],
		   ...
		   function edit(id){
		    ...
		    function _returnData(pageNum) {
		        var url = "${basePath}/admin/permissionIndex";
		        jump(url,pageNum);
		    }
		</script>
	</body>
