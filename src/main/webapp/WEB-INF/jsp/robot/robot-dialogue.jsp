...
<html>
	<head>
		  ...
		  <%-- <link rel="stylesheet" href="${basePath}/css/robot.css"> --%>
		  
		  <link rel="stylesheet" href="${basePath}/layim/css/layim.css">
		  
	</head>
	<body>
		<script src="${basePath}/layim/lay/lib.js"></script>
		  <script src="${basePath}/layim/lay/layer/layer.min.js"></script>
		  <script src="${basePath}/layim/lay/layim.js"></script>
  		...
  		<script>
			layui.use('layim', function(){
			  ...
			  layim.config({
			    //初始化接口
			    init: {
			      url: '/layim/group.json'
			      ,data: {}
			    }
			    //查看群员接口
			    ,members: {
			      url: '/layim/groups.json'
			      ,data: {}
			    }
